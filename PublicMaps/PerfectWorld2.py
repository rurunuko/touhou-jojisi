...
#東方叙事詩・統合MOD追記部分
#日本語化のため記述変更。PangaeaExpansionのものを参考
		"""
		...
		[iOption] = argsList
		option_names = {
			0:	"TXT_KEY_PERFECTWORLD_NEWWORLD_RULES",
			1:	"TXT_KEY_PERFECTWORLD_PANGAEA_RULES",
...
#日本語化のため記述変更。PangaeaExpansionのものを参考
	...
	selection_names = {
		0:	{
			0: "TXT_KEY_PERFECTWORLD_NEWWORLD_OLD_WORLD",
			1: "TXT_KEY_PERFECTWORLD_NEWWORLD_ANYWHERE",
			},
		1:	{
			0: "TXT_KEY_PERFECTWORLD_PANGAEA_OFF",
			1: "TXT_KEY_PERFECTWORLD_PANGAEA_ON",
			},
		2:	{
			0:	"TXT_KEY_MAP_WRAP_CYLINDER",
			1:	"TXT_KEY_MAP_WRAP_TOROID",
			2:  "TXT_KEY_MAP_WRAP_FLAT",
			}
		}
