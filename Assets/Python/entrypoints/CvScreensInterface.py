...
domesticAdvisor = CvModSpecialDomesticAdvisor.CvModSpecialDomesticAdvisor()
...
unitPlacementScreen = CvUnitPlacementScreen.CvUnitPlacementScreen()

alertslogScreen = AlertsLog.AlertsLog()
def showAlertsLogScreen(argsList):
	alertslogScreen.interfaceScreen()

def showGreatPersonScreen(argsList):
	CvGreatPersonScreen.CvGreatPersonScreen().interfaceScreen(argsList[0], argsList[1], argsList[2])
