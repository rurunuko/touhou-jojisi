...
def handleExitButtonInput ( argsList ):
	...
	CGEOptionControl.CGEOptionControl().writeINIFile()
...
def CGESetOptionCheckBoxInput(argsList):
	bValue, szName = argsList
	...
	if (bValue):
		...
		Value = False
	CGEOptionControl.CGEOptionControl().setValue(szName, Value)

	return 1

def  CGESetOptionDropdownInput(argsList):
	iValue, szName = argsList
	CGEOptionControl.CGEOptionControl().setValue(szName, iValue)

	return 1

def  CGESetOptionColorDropdownInput(argsList):
	iValue, szName = argsList
	szColorName = CGEOptionControl.CGEOptionColorIndex[iValue]
	CGEOptionControl.CGEOptionControl().setValue(szName, szColorName)

	return 1

def CGESetOptionEditIntBoxInput(argsList):
	...
	if (szValue.isdigit()):
		...
		popup = PyPopup.PyPopup()
		popup.setHeaderString("")
		popup.setBodyString("Input Error")
		popup.launch()

		return 0

def CGESetOptionEditFloatBoxInput(argsList):
	szValue, szName = argsList

	CheckValue = szValue.replace(".", "0")
	if (CheckValue.isdigit()):
		fValue = float(szValue)
		CGEOptionControl.CGEOptionControl().setValue(szName, fValue)
		return 1
	elif (CheckValue != ""):
		# create popup
		popup = PyPopup.PyPopup()
...
def handleCGEOptions1Reset(argsList):
	"Resets these options"
	szName = argsList

	setDefaultValue = CGEOptionControl.CGEOptionControl().setDefaultValue
...
def handleCGEOptions2Reset(argsList):
	"Resets these options"
	szName = argsList
...
def handleCGEOptions3Reset(argsList):
	"Resets these options"
	szName = argsList
...
def handleCGEOptions4Reset(argsList):
	"Resets these options"
	szName = argsList
...
def handleCGEOptions5Reset(argsList):
	"Resets these options"
	szName = argsList
...
def handleCGEOptions6Reset(argsList):
	"Resets these options"
	szName = argsList
...
def handleCGEOptions7Reset(argsList):
	"Resets these options"
	szName = argsList
