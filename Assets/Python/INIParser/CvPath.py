...
def _getUserDir():
	myDocuments = __getRegValue(_winreg.HKEY_CURRENT_USER, r"Software\Microsoft\Windows\CurrentVersion\Explorer\Shell Folders", "Personal")
...
def _getInstallDir():
	...
	elif (installPath.find("Firaxis")):
		szReg = r"Software\Firaxis Games\Sid Meier's Civilization 4 - Beyond the Sword"
	else:
		szReg = r"Software\CYBERFRONT\Sid Meier's Civilization 4(J) - Beyond the Sword"
