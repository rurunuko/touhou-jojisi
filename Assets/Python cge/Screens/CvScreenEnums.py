...
CivilopediaPageTypes.CIVILOPEDIA_PAGE_INDEX=CivilopediaPageTypes.CIVILOPEDIA_PAGE_PROMOTION_TREE+1
#[MOD] UnitUpgrades / fitchn's Civilopedia Index END
...
#[MOD] UnitUpgrades / fitchn's Civilopedia Index
PEDIA_UPGRADES = CivilopediaPageTypes.CIVILOPEDIA_PAGE_UPGRADES + PEDIA_START
PEDIA_PROMOTION_TREE = CivilopediaPageTypes.CIVILOPEDIA_PAGE_PROMOTION_TREE + PEDIA_START
PEDIA_INDEX = CivilopediaPageTypes.CIVILOPEDIA_PAGE_INDEX + PEDIA_START
PEDIA_HISTORY = PEDIA_INDEX+1

CivilopediaPageTypes.NUM_CIVILOPEDIA_PAGE_TYPES = PEDIA_HISTORY-PEDIA_START
#[MOD] UnitUpgrades / fitchn's Civilopedia Index END

# Unit Placements
UNIT_PLACEMENTS_SCREEN = 6000

# Alerts Log
ALERTS_LOG_SCREEN = 6100
