...
void CyUnit::setNumCombatCombo(int iNewNum)
{
    if (m_pUnit)
		m_pUnit->setNumCombatCombo(iNewNum);
}

int CyUnit::getNumCombatCombo()
{
    return m_pUnit ? m_pUnit->getNumCombatCombo() : -1;
}

int CyUnit::getNumLoseCount()
{
    return m_pUnit->getNumLoseCount();
}

void CyUnit::setNumLoseCount(int iNum)
{
    m_pUnit->setNumLoseCount(iNum);
}


int CyUnit::getNumSpellCardBreakTime()
{
    return m_pUnit->getNumSpellCardBreakTime();
}

void CyUnit::setNumSpellCardBreakTime(int iNum)
{
    m_pUnit->setNumSpellCardBreakTime(iNum);
}

int CyUnit::getNumSpellExtraBreakTime(){

    return m_pUnit->getNumSpellExtraBreakTime();
}

void CyUnit::setNumSpellExtraBreakTime(int iNum)
{
    m_pUnit->setNumSpellExtraBreakTime(iNum);
}

int CyUnit::getNumSpellPhantasmBreakTime(){

    return m_pUnit->getNumSpellPhantasmBreakTime();
}

void CyUnit::setNumSpellPhantasmBreakTime(int iNum)
{
    m_pUnit->setNumSpellPhantasmBreakTime(iNum);
}

int CyUnit::getNumCastSpellCard(){

    return m_pUnit->getNumCastSpellCard();

}

void CyUnit::setNumCastSpellCard(int iNum){

    m_pUnit->setNumCastSpellCard(iNum);

}

int CyUnit::getNumAcquisSpellPromotion(){

    return m_pUnit->getNumAcquisSpellPromotion();

}

void CyUnit::setNumAcquisSpellPromotion(int iNum){

    m_pUnit->setNumAcquisSpellPromotion(iNum);

}

int CyUnit::countCardAttackLevel(){

    return m_pUnit->countCardAttackLevel();

}

void CyUnit::setNumTransformTime(int iNum){

    m_pUnit->setNumTransformTime(iNum);

}

int CyUnit::getNumTransformTime(){

    return m_pUnit->getNumTransformTime();

}

void CyUnit::setbLoseByPlayer(bool flag){

    m_pUnit->setbLoseByPlayer(flag);

}

bool CyUnit::getbLoseByPlayer(){

    return m_pUnit->getbLoseByPlayer();

}

void CyUnit::setSinraDelayTurn(int iNum){

    m_pUnit->setSinraDelayTurn(iNum);

}

int CyUnit::getSinraDelayTurn(){

    return m_pUnit->getSinraDelayTurn();

}


void CyUnit::setSpecialNumber(int iNum){

    m_pUnit->setSpecialNumber(iNum);

}

int CyUnit::getSpecialNumber(){

    return m_pUnit->getSpecialNumber();

}


void CyUnit::setAIPromotionRoute(int iNum){

    m_pUnit->setAIPromotionRoute(iNum);

}

int CyUnit::getAIPromotionRoute(){

    return m_pUnit->getAIPromotionRoute();

}


void CyUnit::setDanmakuKekkai(int iNow,int iMax){

    m_pUnit->setDanmakuKekkai(iNow,iMax);

}

int CyUnit::getNowDanmakuKekkai(){

    return m_pUnit->getNowDanmakuKekkai();

}

int CyUnit::getMaxDanmakuKekkai(){

    return m_pUnit->getMaxDanmakuKekkai();

}


int CyUnit::countSpellTolerance(){

    return m_pUnit->countSpellTolerance();

}

int CyUnit::countExpByTrun(){

    return m_pUnit->countExpByTrun();

}

int CyUnit::countAutoHeal(){

    return m_pUnit->countAutoHeal();

}

void CyUnit::countCombatBonus(){
    m_pUnit->countCombatBonus();
}

int CyUnit::getTohoExtraCombatPercent(){
    return m_pUnit->getTohoExtraCombatPercent();
}

int CyUnit::getTohoBaseCombat(){
    return m_pUnit->getTohoBaseCombat();
}

void CyUnit::setPower(double iNum){
    m_pUnit->setPower(iNum);
}

double CyUnit::getPower(){
    return m_pUnit->getPower();
}


void CyUnit::setNumPowerUp(int index,int iNum){

    m_pUnit->setNumPowerUp(index,iNum);
}

int CyUnit::getNumPowerUp(int index){
