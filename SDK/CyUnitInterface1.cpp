...
void CyUnitPythonInterface1(python::class_<CyUnit>& x)
{
	...
	x
		...
		//ìåï˚èñéñéçóp
        .def("setNumCombatCombo", &CyUnit::setNumCombatCombo, "void (int iNewNum)")
        .def("getNumCombatCombo", &CyUnit::getNumCombatCombo, "int ()")
        .def("setNumLoseCount", &CyUnit::setNumLoseCount, "void (int iNewNum)")
        .def("getNumLoseCount", &CyUnit::getNumLoseCount, "int ()")
        .def("setNumCastSpellCard", &CyUnit::setNumCastSpellCard, "void (int iNewNum)")
        .def("getNumCastSpellCard", &CyUnit::getNumCastSpellCard, "int ()")
        .def("setNumAcquisSpellPromotion", &CyUnit::setNumAcquisSpellPromotion, "void (int iNewNum)")
        .def("getNumAcquisSpellPromotion", &CyUnit::getNumAcquisSpellPromotion, "int ()")
        .def("countCardAttackLevel", &CyUnit::countCardAttackLevel, "int ()")
        .def("setNumTransformTime", &CyUnit::setNumTransformTime, "void (int iNewNum)")
        .def("getNumTransformTime", &CyUnit::getNumTransformTime, "int ()")
        .def("setbLoseByPlayer", &CyUnit::setbLoseByPlayer, "void (bool bFlag)")
        .def("getbLoseByPlayer", &CyUnit::getbLoseByPlayer, "bool ()")
        .def("setSinraDelayTurn", &CyUnit::setSinraDelayTurn, "void (int iNewNum)")
        .def("getSinraDelayTurn", &CyUnit::getSinraDelayTurn, "int ()")
        .def("setSpecialNumber", &CyUnit::setSpecialNumber, "void (int iNum)")
        .def("getSpecialNumber", &CyUnit::getSpecialNumber, "int ()")
        .def("setAIPromotionRoute", &CyUnit::setAIPromotionRoute, "void (int iNum)")
        .def("getAIPromotionRoute", &CyUnit::getAIPromotionRoute, "int ()")
        .def("setDanmakuKekkai", &CyUnit::setDanmakuKekkai, "void (int iNom, int iMax)")
        .def("getNowDanmakuKekkai", &CyUnit::getNowDanmakuKekkai, "int ()")
        .def("getMaxDanmakuKekkai", &CyUnit::getMaxDanmakuKekkai, "int ()")
        .def("countSpellTolerance", &CyUnit::countSpellTolerance, "int ()")
        .def("countExpByTrun", &CyUnit::countExpByTrun, "int ()")
        .def("countAutoHeal", &CyUnit::countAutoHeal, "int ()")
        .def("countCombatBonus", &CyUnit::countCombatBonus, "void ()")
        .def("getTohoExtraCombatPercent", &CyUnit::getTohoExtraCombatPercent, "int ()")
        .def("getTohoBaseCombat", &CyUnit::getTohoBaseCombat, "int ()")
        .def("setPower", &CyUnit::setPower, "void (double iNum)")
        ...
        .def("setNumSpellExtraBreakTime", &CyUnit::setNumSpellExtraBreakTime, "void (int iNum)")
        .def("getNumSpellExtraBreakTime", &CyUnit::getNumSpellExtraBreakTime, "int ()")
        .def("setNumSpellPhantasmBreakTime", &CyUnit::setNumSpellPhantasmBreakTime, "void (int iNum)")
        .def("getNumSpellPhantasmBreakTime", &CyUnit::getNumSpellPhantasmBreakTime, "int ()")
